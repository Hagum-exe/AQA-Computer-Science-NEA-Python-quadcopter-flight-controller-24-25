...
df = pd.read_csv('angle_mpu_IO_test.csv')
print(df.head)
index = list(df.index.values)
pitch_angle_list = df['angle_pitch'].values.tolist()
roll_angle_list = df['angle_roll'].values.tolist()

pitch_sp_list =  df['rate_sp_pitch'].values.tolist()
roll_sp_list =  df['rate_sp_roll'].values.tolist()
...
axis[0].plot(index, roll_angle_list, color = 'orange')
axis[1].plot(index, roll_sp_list, color = 'blue')
