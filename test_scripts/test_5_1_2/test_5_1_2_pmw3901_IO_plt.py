...
df = pd.read_csv('horiz_velo_IO_test.csv')
print(df.head)
index = list(df.index.values)

velo_x_list = df['velo_x'].values.tolist()
velo_y_list = df['velo_y'].values.tolist()
...
axis[0].plot(index, velo_x_list, color = 'orange')
...
axis[0].plot(index, velo_y_list, color = 'orange')
